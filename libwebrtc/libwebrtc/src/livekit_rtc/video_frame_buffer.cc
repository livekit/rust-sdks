...
webrtc::scoped_refptr<I420Buffer> VideoFrameBuffer::to_i420() const {
  return webrtc::make_ref_counted<I420Buffer>(buffer_->ToI420());
}

// const_cast is valid here because we take the ownership on the rust side
webrtc::scoped_refptr<I420Buffer> VideoFrameBuffer::get_i420() {
  return webrtc::make_ref_counted<I420Buffer>(
      webrtc::scoped_refptr<webrtc::I420BufferInterface>(
          const_cast<webrtc::I420BufferInterface*>(buffer_->GetI420())));
}

webrtc::scoped_refptr<I420ABuffer> VideoFrameBuffer::get_i420a() {
  return webrtc::make_ref_counted<I420ABuffer>(
      webrtc::scoped_refptr<webrtc::I420ABufferInterface>(
          const_cast<webrtc::I420ABufferInterface*>(buffer_->GetI420A())));
}

webrtc::scoped_refptr<I422Buffer> VideoFrameBuffer::get_i422() {
  return webrtc::make_ref_counted<I422Buffer>(
      webrtc::scoped_refptr<webrtc::I422BufferInterface>(
          const_cast<webrtc::I422BufferInterface*>(buffer_->GetI422())));
}

webrtc::scoped_refptr<I444Buffer> VideoFrameBuffer::get_i444() {
  return webrtc::make_ref_counted<I444Buffer>(
      webrtc::scoped_refptr<webrtc::I444BufferInterface>(
          const_cast<webrtc::I444BufferInterface*>(buffer_->GetI444())));
}

webrtc::scoped_refptr<I010Buffer> VideoFrameBuffer::get_i010() {
  return webrtc::make_ref_counted<I010Buffer>(
      webrtc::scoped_refptr<webrtc::I010BufferInterface>(
          const_cast<webrtc::I010BufferInterface*>(buffer_->GetI010())));
}

webrtc::scoped_refptr<NV12Buffer> VideoFrameBuffer::get_nv12() {
  return webrtc::make_ref_counted<NV12Buffer>(
...
webrtc::scoped_refptr<I420Buffer> I420Buffer::scale(int scaled_width,
...
webrtc::scoped_refptr<I420ABuffer> I420ABuffer::scale(int scaled_width,
                                                int scaled_height) const {
  rtc::scoped_refptr<webrtc::VideoFrameBuffer> result =
      buffer()->Scale(scaled_width, scaled_height);
  return webrtc::make_ref_counted<I420ABuffer>(
...
webrtc::scoped_refptr<I422Buffer> I422Buffer::scale(int scaled_width,
                                              int scaled_height) const {
  rtc::scoped_refptr<webrtc::VideoFrameBuffer> result =
      buffer()->Scale(scaled_width, scaled_height);
  return webrtc::make_ref_counted<I422Buffer>(
...
webrtc::scoped_refptr<I444Buffer> I444Buffer::scale(int scaled_width,
                                              int scaled_height) const {
  rtc::scoped_refptr<webrtc::VideoFrameBuffer> result =
      buffer()->Scale(scaled_width, scaled_height);
  return webrtc::make_ref_counted<I444Buffer>(
...
webrtc::scoped_refptr<I010Buffer> I010Buffer::scale(int scaled_width,
                                              int scaled_height) const {
  rtc::scoped_refptr<webrtc::VideoFrameBuffer> result =
      buffer()->Scale(scaled_width, scaled_height);
  return webrtc::make_ref_counted<I010Buffer>(
...
webrtc::scoped_refptr<NV12Buffer> NV12Buffer::scale(int scaled_width,
                                              int scaled_height) const {
  rtc::scoped_refptr<webrtc::VideoFrameBuffer> result =
      buffer()->Scale(scaled_width, scaled_height);
  return webrtc::make_ref_counted<NV12Buffer>(
...
webrtc::scoped_refptr<I420Buffer> copy_i420_buffer(
  ...
  return webrtc::make_ref_counted<I420Buffer>(webrtc::I420Buffer::Copy(*i420->get()));
}

webrtc::scoped_refptr<I420Buffer> new_i420_buffer(int width,
                                            int height,
                                            int stride_y,
                                            int stride_u,
                                            int stride_v) {
...
webrtc::scoped_refptr<I422Buffer> new_i422_buffer(int width,
                                            int height,
                                            int stride_y,
                                            int stride_u,
                                            int stride_v) {
...
webrtc::scoped_refptr<I444Buffer> new_i444_buffer(int width,
                                            int height,
                                            int stride_y,
                                            int stride_u,
                                            int stride_v) {
...
webrtc::scoped_refptr<I010Buffer> new_i010_buffer(int width,
                                            int height,
                                            int stride_y,
                                            int stride_u,
                                            int stride_v) {
  return webrtc::make_ref_counted<I010Buffer>(webrtc::make_ref_counted<webrtc::I010Buffer>(
...
lkPlatformImageBuffer* native_buffer_to_platform_image_buffer(
