...
export declare class FfiRequest extends Message<FfiRequest> {
  ...
  message: {
     ...
     *
     * @generated from field: livekit.proto.NewCaptureSourceRequest new_capture_source = 91;
     */
...
export declare class FfiResponse extends Message<FfiResponse> {
  ...
  message: {
     ...
     * Capture sources (livekit-capture; requires the `capture` feature)
     *
     * @generated from field: livekit.proto.NewCaptureSourceResponse new_capture_source = 91;
     */
