...
const FfiRequest = /*@__PURE__*/ proto2.makeMessageType(
  ...
  () => [
    ...
    { no: 80, name: "start_recording", kind: "message", T: StartRecordingRequest, oneof: "message" },
    { no: 81, name: "stop_recording", kind: "message", T: StopRecordingRequest, oneof: "message" },
  ],
);
...
const FfiResponse = /*@__PURE__*/ proto2.makeMessageType(
  ...
  () => [
    ...
    { no: 79, name: "start_recording", kind: "message", T: StartRecordingResponse, oneof: "message" },
    { no: 80, name: "stop_recording", kind: "message", T: StopRecordingResponse, oneof: "message" },
  ],
);
