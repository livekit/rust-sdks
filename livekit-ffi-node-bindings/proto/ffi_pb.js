...
const FfiRequest = /*@__PURE__*/ proto2.makeMessageType(
  ...
  () => [
    ...
    { no: 79, name: "set_recording_device", kind: "message", T: SetRecordingDeviceRequest, oneof: "message" },
    { no: 80, name: "set_playout_device", kind: "message", T: SetPlayoutDeviceRequest, oneof: "message" },
    ...
    { no: 85, name: "capture_encoded_video_frame", kind: "message", T: CaptureEncodedVideoFrameRequest, oneof: "message" },
  ],
);
...
const FfiResponse = /*@__PURE__*/ proto2.makeMessageType(
  ...
  () => [
    ...
    { no: 78, name: "set_recording_device", kind: "message", T: SetRecordingDeviceResponse, oneof: "message" },
    { no: 79, name: "set_playout_device", kind: "message", T: SetPlayoutDeviceResponse, oneof: "message" },
    ...
    { no: 85, name: "capture_encoded_video_frame", kind: "message", T: CaptureEncodedVideoFrameResponse, oneof: "message" },
  ],
);
...
const FfiEvent = /*@__PURE__*/ proto2.makeMessageType(
  ...
  () => [
    ...
    { no: 45, name: "encoded_video_source_event", kind: "message", T: EncodedVideoSourceEvent, oneof: "message" },
  ],
);
