...
- Pause and join platform capture while removing audio senders, preventing `AudioTransportImpl::SendProcessedData` from dispatching through an `AudioSender` entry that is being destroyed.
