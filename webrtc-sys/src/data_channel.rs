...
}, sys::{lkDataChannelObserver, lkDcState}};
...
impl DataChannelObserver {
    ...
    fn lk_on_state_change(&self, state: lkDcState) {
    ...
    fn lk_on_message(&self, data: &[u8], binary: bool) {
    ...
    fn lk_on_buffered_amount_change(&self, sent_data_size: u64) {
