...
#ifndef MPP_H265_ENCODER_IMPL_H_
#define MPP_H265_ENCODER_IMPL_H_
...
class MppH265EncoderImpl : public VideoEncoder {
 ...
 public:
  MppH265EncoderImpl(const webrtc::Environment& env,
                     const SdpVideoFormat& format);
  ~MppH265EncoderImpl() override;
...
#endif  // MPP_H265_ENCODER_IMPL_H_
