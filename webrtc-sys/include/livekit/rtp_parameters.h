...
static webrtc::RtpExtension to_native_rtp_extension(RtpExtension ext) {
...
static webrtc::RtpParameters to_native_rtp_parameters(RtpParameters params) {
...
static RtcpFeedback to_rust_rtcp_feedback(webrtc::RtcpFeedback feedback) {
  RtcpFeedback rust;
...
static RtpCodecCapability to_rust_rtp_codec_capability(
...
static RtpHeaderExtensionCapability to_rust_rtp_header_extension_capability(
...
static RtpExtension to_rust_rtp_extension(webrtc::RtpExtension ext) {
  RtpExtension rust;
  rust.uri = ext.uri;
  rust.id = ext.id;
...
static RtpFecParameters to_rust_rtp_fec_parameters(
    webrtc::RtpFecParameters fec) {
...
static RtpRtxParameters to_rust_rtp_rtx_parameters(
    webrtc::RtpRtxParameters param) {
...
static RtpEncodingParameters to_rust_rtp_encoding_parameters(
...
static RtpCodecParameters to_rust_rtp_codec_parameters(
...
static RtpCapabilities to_rust_rtp_capabilities(
...
static RtcpParameters to_rust_rtcp_parameters(webrtc::RtcpParameters params) {
  RtcpParameters rust;
  if (params.ssrc.has_value()) {
    rust.has_ssrc = true;
    rust.ssrc = params.ssrc.value();
...
static RtpParameters to_rust_rtp_parameters(webrtc::RtpParameters params) {
  RtpParameters rust;
