...
echo "Building LiveKit WebRTC - UWP"
echo "Arch: !arch!"
...
set ARTIFACTS_DIR=%cd%\winuwp-!arch!-!profile!
...
call gn.bat gen %OUTPUT_DIR% --root="src" ^
  --args="is_debug=!debug! is_clang=true target_os=\"winuwp\" target_cpu=\"!arch!\" use_custom_libcxx=false rtc_include_tests=false rtc_build_examples=false rtc_build_tools=false is_component_build=false rtc_enable_protobuf=false rtc_use_h264=true symbol_level=0 enable_iterator_debugging=false use_cxx17=true"
