...
[`livekit-ffi`](https://github.com/livekit/rust-sdks/tree/main/livekit-ffi)
...
from the matching [`livekit-ffi` release](https://github.com/livekit/rust-sdks/releases)
...
See the [crate README](https://github.com/livekit/rust-sdks/tree/main/livekit-ffi)
